...
namespace noitomDataReaderWraper
{
    ...
    {
        public float Head;              // Bone length of head
        public float Neck;              // Bone length of neck
        public float Body;              // Length of body
        public float ShoulderWidth;     // Width of shoulder
        public float UpperArm;          // Bone length of upper arm
        public float Forearm;           // Bone length of forearm
        public float Palm;              // Bone length of hand
        public float HipWidth;          // Width of hip
        public float UpperLeg;          // Bone length of upper leg
        public float LowerLeg;          // Bone length of lower leg
        public float HeelHeight;        // Heel height
        public float FootLength;        // Foot length
    };
    ...
    public class DataReader
    {
...
#else
#if DEBUG
		private const string ReaderImportor = "NeuronDataReaderd.dll";
#else
        ...
        [DllImport(ReaderImportor, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, ExactSpelling = true)]
